...
if(mo.x-cpi.x < mo.width/2 + cpi.width/2
...
if(mo.x-cpb.x < mo.width/2 + cpb.width/2
...
if(mo.x-cpg.x < mo.width/2 + cpg.width/2
...
if(mo.x-cpy.x < mo.width/2 + cpy.width/2
...
if(mo.x-cpo.x < mo.width/2 + cpo.width/2
...
if(mo.x-cpr.x < mo.width/2 + cpr.width/2
